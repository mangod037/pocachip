const randomName = Math.random().toString(36).replace(/[^a-z]+/g, ``).substr(0, 4).concat(`.wav`);
...
const record = async () => {
  ...
  const fileName = path.join(DIRECTORY, randomName);
...
module.exports = { record, randomName }